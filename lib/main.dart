...
- 연령 등급은 17세 이상이어야 합니다.

- 사용자가 약관(EULA)에 동의하도록 요구하고, 이러한 약관에는 불쾌감을 주는 콘텐츠나 학대적인 사용자에 대한 관용이 없다는 점을 명확히 명시해야 합니다.

- 불쾌한 콘텐츠를 필터링하는 방법

- 사용자가 불쾌한 콘텐츠를 표시할 수 있는 메커니즘
...
App Store Connect에 제공된 지원 URL https://jhh78.github.io/ 는 사용자가 질문을 하거나 지원을 요청하는 데 사용할 수 있는 정보가 있는 웹사이트로 연결되지 않습니다.


다음 단계


지정된 지원 URL을 업데이트하여 사용자를 지원 정보가 있는 웹 페이지로 이동시킵니다.


자원


App Store Connect 도움말 에서 지원 URL 및 기타 플랫폼 버전 정보를 알아보세요 .
