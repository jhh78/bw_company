...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ko_KR': {
          ...
          'modifyRequestSuccess': '수정요청이 완료되었습니다.',
        ...
        'ja_JP': {
          'pleaseTouchScreenAndStart': '画面をタッチしてスタート',
          ...
          'policyAgree': '同意します。',
          'appInfoTitle': 'このアプリは無記名で運営され、個人情報は収集しません。',
          ...
          'modifyRequestSuccess': '修正依頼が完了しました。',
        ...
        'en_US': {
          ...
          'modifyRequestSuccess': 'Modification request has been completed.',
